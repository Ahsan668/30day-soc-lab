...
Day-by-day notes covering Days 1-14 of the MyDFIR 30-Day SOC Analyst Challenge. Built
...
- No formal Kibana detection rules/alerts (Security > Rules) have been created yet —
  all validation so far has been via Discover ad-hoc searches, not saved detection
  rules.
- The Day 14 "failed SSH logins over time" visualization has not been confirmed as
  rendering correctly or saved to a dashboard.

## Not yet documented

Days 15-30 are not covered — this repo currently documents Days 1-14 only.
